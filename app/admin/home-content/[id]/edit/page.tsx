...
import { getHomeSection, updateHomeSection, deleteHomeSection } from "@/lib/api/admin/homeSections"
import { ArrowLeft, Trash2 } from "lucide-react"

export default function EditHomeContentPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const fetchSection = async (id: string) => {
        try {
            ...
            setFormData({
                ...
                ctaText: section.ctaText || 'Shop Now',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setSaving(true)
            await updateHomeSection(id, formData)
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-primary">Edit Homepage Content</h1>
                            <p className="text-foreground/60 mt-1">{formData.title}</p>
                        </div>
                    </div>
                    <button
