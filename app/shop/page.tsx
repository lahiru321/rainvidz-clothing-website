...
import { getAllProducts, filterAndSortProducts, FilterState, SortOption } from "@/lib/data"
...
export default function ShopPage() {
    ...
    const filteredProducts = filterAndSortProducts(allProducts, filters, sort)
            ...
            <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Explore our complete collection of bohemian styles.
                    </p>
                </div>
